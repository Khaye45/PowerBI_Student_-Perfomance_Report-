...
I imported the [CSV file](https://github.com/Khaye45/PowerBI_Student_-Perfomance_Report-/blob/main/StudentsPerformance.xlsx)  into Power BI and launched the dataset in Power Query Editor. My data cleaning process involved checking out for:  
